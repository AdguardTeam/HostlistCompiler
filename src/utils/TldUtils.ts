...
const COMMON_PUBLIC_SUFFIXES = new Set([
    ...
    'app', 'dev', 'io', 'co', 'me', 'tv', 'cc', 'ws', 'mobi',
    'asia', 'tel', 'jobs', 'travel', 'xxx', 'cat',

    // Country code TLDs (common ones)
    'uk', 'us', 'ca', 'au', 'de', 'fr', 'it', 'es', 'nl', 'be',
    'ch', 'at', 'se', 'no', 'dk', 'fi', 'pl', 'cz', 'ru', 'ua',
    'br', 'mx', 'ar', 'cl', 'co', 'pe', 've',
    'jp', 'cn', 'kr', 'tw', 'hk', 'sg', 'in', 'id', 'my', 'th', 'vn', 'ph',
    'za', 'eg', 'ng', 'ke',
    'nz', 'il', 'ae', 'sa', 'tr', 'gr', 'pt', 'ie', 'hu', 'ro',

    // New gTLDs (common ones)
    'xyz', 'online', 'site', 'tech', 'store', 'blog', 'cloud', 'club',
    'shop', 'live', 'news', 'world', 'network', 'digital', 'media',
    'global', 'email', 'support', 'solutions', 'services', 'agency',
    'company', 'systems', 'technology', 'marketing', 'consulting',
]);
...
const MULTI_PART_SUFFIXES = new Set([
    ...
    // Other common ones
    'co.id', 'or.id', 'web.id', 'sch.id', 'go.id',
    ...
    'ae.org', 'com.ae', 'net.ae', 'org.ae', 'gov.ae',
]);
