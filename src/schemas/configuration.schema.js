 ...
 * The enum's declaration order is preserved here — it is what the
 * unknown-transformation error renders as the allowed-values list (pinned by a
 * test in configuration.test.js).
 */
