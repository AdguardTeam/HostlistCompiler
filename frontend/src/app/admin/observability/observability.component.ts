...
@Component({
    ...
    <mat-card appearance="outlined">
        <mat-card-header>
            ...
            <mat-card-subtitle>Logs, traces, and system health</mat-card-subtitle>
        </mat-card-header>
        <mat-card-content>
            <p class="placeholder">Coming soon — structured log viewer, trace explorer, and health dashboard.</p>
        </mat-card-content>
    </mat-card>
    `,
