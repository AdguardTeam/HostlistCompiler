...
@Component({
    ...
    <mat-card appearance="outlined">
        <mat-card-header>
            ...
            <mat-card-subtitle>Configure outbound webhook subscriptions</mat-card-subtitle>
        </mat-card-header>
        <mat-card-content>
            <p class="placeholder">Coming soon — webhook endpoint management with event filtering and delivery logs.</p>
        </mat-card-content>
    </mat-card>
    `,
