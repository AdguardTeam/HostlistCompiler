...
@Component({
    ...
    <mat-card appearance="outlined">
        <mat-card-header>
            ...
            <mat-card-subtitle>Configure authentication requirements per endpoint</mat-card-subtitle>
        </mat-card-header>
        <mat-card-content>
            <p class="placeholder">Coming soon — endpoint table with auth method, scope, and rate-limit overrides.</p>
        </mat-card-content>
    </mat-card>
    `,
